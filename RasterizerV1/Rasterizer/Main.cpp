...
void updateVerts() {
	vertsScreen = OH.convert2D(vertices, 70, offset, 20);
}
...
void UDVEF() {
	...
	vector<Tris> faces = { Tris(vertsScreen.at(0), vertsScreen.at(1), vertsScreen.at(2), red),
						   Tris(vertsScreen.at(1), vertsScreen.at(0), vertsScreen.at(3), green),
						   Tris(vertsScreen.at(3), vertsScreen.at(2), vertsScreen.at(0), blue),
						   Tris(vertsScreen.at(2), vertsScreen.at(3), vertsScreen.at(1), white) };

	for (size_t i = 0; i < faces.size(); i++) {	
		if (faces.at(i).getNormal().getZ() < 0) {
			raster.PutTris((int)faces.at(i).v1.getX(), (int)faces.at(i).v1.getY(), (int)faces.at(i).v2.getX(), (int)faces.at(i).v2.getY(), (int)faces.at(i).v3.getX(), (int)faces.at(i).v3.getY(), faces.at(i).c, pixelSpace);
		}	
	}
